    ...
    return (
        ...
        <div className="container flex justify-between items-center mx-auto h-16">
          ...
          <nav className="flex items-center gap-x-2 text-slate-700 font-medium">
            <NavLink to="/" className="hover:bg-slate-100 py-2 px-4 rounded transition">
              Inicio
            </NavLink>
            <NavLink to="/proyectos" className="hover:bg-slate-100 py-2 px-4 rounded transition">
              Proyectos
            </NavLink>
            <NavLink to="/sobre-mi" className="hover:bg-slate-100 py-2 px-4 rounded transition">
              Sobre mi
            </NavLink>
          </nav>
        </div>
